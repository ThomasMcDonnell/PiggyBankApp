...
class CompanyCreate(LoginRequiredMixin, SetHeadlineMixin, generic.CreateView):
...
class CompanyUpdate(LoginRequiredMixin, SetHeadlineMixin, generic.UpdateView):
    form_class = forms.CompanyForm
    template_name = 'companies/company_form.html'
...
class CompanyDetail(LoginRequiredMixin, generic.FormView):
